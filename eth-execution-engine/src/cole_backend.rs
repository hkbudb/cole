...
impl<'a> ColeBackend<'a> {
    ...
    pub fn get_mut_total_tree(&self) -> &'a mut Cole<'a> {
        unsafe {
            ...
            let mut_ptr = const_ptr as *mut Cole;
            &mut *mut_ptr
        }
    }
}

impl<'a> Backend for ColeBackend<'a> {
...
impl<'a> BackendWriteTrait for ColeBackend<'a> {
